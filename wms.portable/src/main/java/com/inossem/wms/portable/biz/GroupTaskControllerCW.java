...
//			param.put("stockTaskReqCode", json.getString("refer_receipt_code").trim());
	...
	// 上架作业-1.1.8 获取新托盘
	@RequestMapping(value = {
			"/biz/group_task/get_new_pallet" }, method = RequestMethod.GET, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = "/biz/group_task/delete/{stock_task_id}", method = RequestMethod.GET, produces = "application/json;charset=UTF-8")
