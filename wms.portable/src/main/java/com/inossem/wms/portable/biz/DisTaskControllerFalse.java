...
public class DisTaskControllerFalse {
	...
	public @ResponseBody JSONObject submit(@RequestBody JSONObject json, CurrentUser cUser) {
		...
		String jsonStr = "{\"head\":{\"status\":\"true\",\"error_code\":\"0\",\"msg\":\"下架成功\",\"page_index\":\"1\",\"page_size\":\"20\",\"total\":\"0\"},\"body\":{}}";
		return JSONObject.fromObject(jsonStr);
	}
	...
	// 下架作业-添加仓位
	@RequestMapping(value = "/removal/add_position_list", method = RequestMethod.GET, produces = "application/json;charset=UTF-8")
	public @ResponseBody JSONObject getPositionList(CurrentUser cUser) {

		String jsonStr = "{\"head\":{\"status\":true,\"error_code\":0,\"msg\":\"\",\"page_index\":1,\"page_size\":20,\"total\":5},\"body\":[{\"position_id\":\"1\",\"position_code\":\"01-2222\"},{\"position_id\":\"2\",\"position_code\":\"01-2233\"},{\"position_id\":\"3\",\"position_code\":\"01-2244\"}]}";
