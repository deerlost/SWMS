...
/**
 * <p>WmInvQueryNewResult complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="WmInvQueryNewResult">
 *   &lt;complexContent>
 ...
 *         &lt;element name="MtrlAlias" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlType(name = "WmInvQueryNewResult", propOrder = {
    "invId",
    "mvRecId",
    "mtrlId",
    "mtrlCode",
...
public class WmInvQueryNewResult {
    ...
    @XmlElement(name = "MtrlCode")
    protected String mtrlCode;
    @XmlElement(name = "MtrlAlias")
    protected String mtrlAlias;
    @XmlElement(name = "Bch")
     ...
     *     
     */
    public void setMtrlAlias(String value) {
        this.mtrlAlias = value;
    }
