            ...
            if(data.body.type==1){          //托盘
                ...
                if(sn_list[index].position_id!=data.body.position_id && data.body.position_id!=""){
                    ...
                    if(data.body.package_list.length==0){
                        ...
                        sn_list[index].yuan_have_payload=0
                        dataPosition()
                        dataPack()
                        return false
                    }
...
function dataPosition(){
    ...
    $.each(sn_list,function(i,item){
        ...
        item.have_payload=item.yuan_have_payload+qty||0
    })
    dataBindPosition()
}
...
function dataBindPosition(){
    g1=$("#id_div_grid_position").iGrid({
        columns: [
            ...
            { th: '仓位', col: 'position_id', sort:false,type:table.select,data:position,text:"position_name",value:"position_id",parent:"area_id",width:140},
            { th: '托盘编号', col: 'pallet_code', sort:false,width:110},
    ...
    if(GetQueryString("view")!=null){
        ...
        $.each(indexdata.pallet_package_list,function(i,item){
            ...
            if(is_add){
                ...
                sn_list[rid].yuan_have_payload=item.have_payload-item.qty
