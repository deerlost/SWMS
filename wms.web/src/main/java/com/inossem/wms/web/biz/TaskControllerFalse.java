...
public class TaskControllerFalse {
	...
	@RequestMapping(value = "/shelves/area_list", method = RequestMethod.GET, produces = "application/json;charset=UTF-8")
	...
	// 上架作业-1.1.7 获取上架单详情
	@RequestMapping(value = "/shelves/get_inner_task_details", method = RequestMethod.GET, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = {"/shelves/position_list" }, method = RequestMethod.POST, produces = "application/json;charset=UTF-8")
