...
function dataBind() {
	$("#id_div_grid").iGrid({
		columns: [ 
			{ th: '公司代码', col: 'corp_code' },
			{ th: '公司名称', col: 'corp_name' },
			{ th: '创建日期', col: 'create_time' },
			{ th: '所属板块代码', col: 'board_name' },
			{ th: '操作', col: 'board_id', class:"", sort:false, min:60,align: 'left',type:"popup",
			popup:{
					display:"修改",
					href:"editcompany.html?action=modify",//默认带index= 数据row下标。
					area:"700px,400px",
					title:"修改",
					args:['corp_id']//还需要什么参数，都写在这里，如例子：合同编号、采购订单号
				}
			},
		], 
		data: indexdata.body,
